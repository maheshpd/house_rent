class House {
  ...
  static List<House> genetateRecommended() {
    return [
  ...
  static List<House> generateBestOffer() {
    return [
      House('The Moon House', 'P455, Chhatak, sylhet', 'assets/images/offer01.jpeg'),
      House('The Moon House', 'P455, Chhatak, sylhet', 'assets/images/offer02.jpeg')
    ];
  }
